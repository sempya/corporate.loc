                            ...
                            <div class="work-thumbnail">
                                ...
                                <div class="work-overlay">
                                    ...
                                    <p class="work-overlay-categories"><img
                                                ...
                                                alt="Categories"/> in:
                                        <a href="{{-- route('portfolios.show') --}}">{{ $item->filter->title }}</a></p>
                                </div>
                            </div>
                            <div class="work-description">
                                <h2><a href="{{ route('portfolios.show', ['alias' => $item->alias]) }}">
                                        {{ $item->title }}</a></h2>
                                <p class="work-categories">in: <a
                                            href="{{-- route('portfolios.show') --}}">{{ $item->filter->title }}</a></p>
                    ...
                    @if($k == 1)
                        <div class="portfolio-projects">
                            ...
                            <div class="related_project {{ ($k==4 ? ' related_project_last' : '') }}">
                                ...
                                <h4><a href="{{ route('portfolios.show', ['alias' => $item->alias]) }}">
                                        {{ $item->title }}</a></h4>
                                <p>{{ str_limit($item->text, 200) }}</p>
                            </div>
                            @endforeach
