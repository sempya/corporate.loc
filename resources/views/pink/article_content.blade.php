        ...
        @if($article)
            ...
            <div class="meta group">
                ...
                <p class="comments"><span><a href="#comments"
                            ...
                            {{ count($article->comments) .' '. Lang::choice('ru.comments', count($article->comments)) }}</a></span>
                </p>
            </div>
            <!-- post content -->
    ...
    <!-- START TRACKBACK & PINGBACK -->
        ...
        <div id="respond">
            ...
            <form action="{{ route('comment.store') }}" method="post" id="commentform">
                ...
                @if(!Auth::check())
                    <p class="comment-form-author"><label for="author">Name</label> <input id="author" name="name"
                                                                                           type="text" value=""
                                                                                           size="30"
