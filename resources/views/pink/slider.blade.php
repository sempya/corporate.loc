            ...
            @foreach($sliders as $slider)
                <li>
                    <div class="slide-holder"
                         style="background:  url('{{ asset(env('THEME')) }}/images/{{ $slider->img }}')
                                 no-repeat center center"
                         style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
                            @if($i%2 != 0)
                                <div class="slide-content-holder-content" style="position: absolute;
        ...
        <div id="yit-widget-area" class="group">
            <div class="yit-widget-content inner group">
                ...
                <div class="widget-last yit-widget widget col1_4 one-fourth col yit_text_quote">
                    <blockquote class="text-quote-quote">�Anyone who has never made a mistake
